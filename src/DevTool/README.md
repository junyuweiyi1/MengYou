...
- **UILayout 坐标**：读入/写出 `src/Core/Config/UILayout.json`
- **模板 PNG**：从截图裁剪并保存到 `src/Core/Config/Templates/`

## 运行

```
dotnet run --project src/DevTool/DevTool.csproj
```
...
模板文件保存到 `src/Core/Config/Templates/{键名}.png`。
