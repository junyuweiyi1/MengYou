...
/// </summary>
public sealed class UILayoutLocator : IUIElementLocator
{
    ...
    /// <summary>构造。</summary>
    private UILayoutLocator(Dictionary<string, Point2D> points, Dictionary<string, Rect> regions)
    {
        _points = points;
        _regions = regions;
    }
    ...
    public static UILayoutLocator LoadFromFile(string path)
    {
        ...
        return new UILayoutLocator(points, regions);
    }
