...
namespace MengYou.Input.Simulated.Decorators;

/// <summary>
/// 人性化装饰器：在原始 Controller 外包一层，加入随机延迟与轻微轨迹抖动。
/// 通过组合而非继承，符合"装饰器模式"。
/// </summary>
public sealed class HumanizedController : IGameController
{
    /// <summary>被包裹的内部 Controller。</summary>
    private readonly IGameController _inner;
    ...
    public HumanizedController(IGameController inner, int preDelayMinMs = 30, int preDelayMaxMs = 120)
    {
        _inner = inner;
